...
namespace SoliditySHA3Miner
{
    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var WhatAddressToMineTo = Config.minerAddress;
            try
            {
                ...
                Console.WriteLine("[THIS] GOING TO PaymasterContract Address: "+Config.UsePayMaster);
                if (Config.UsePayMaster == true)
                {
                    ...
                    string CheckMinAmountInterval4 = jsonObj["minerAddress"].Value<String>();
                    // Use the value as needed
                    Console.WriteLine("UsePaymaster contractAddressPayMaster: " + CheckMinAmountInterval2);

                    var payAddress = Config.contractAddressPayMaster;
                    var minerAddressz = Config.minerAddress;
                    var web3apiz = Config.web3api;
                    ...
                    string publicAddress = CheckMinAmountInterval4;
                    ...
                    Console.WriteLine("[THIS] GOING TO PaymasterContract Address");
                    if(checksummedAddress != "0x0000000000000000000000000000000000000000")
                    {
                        WhatAddressToMineTo = checksummedAddress;

                    }
                    else
                    {
                        WhatAddressToMineTo = CheckMinAmountInterval2;
                    }
                ...
                {
                    Console.WriteLine("[THIS2323] GOING TO PaymasterContract Address");

                    var web3Interface = new NetworkInterface.Web3Interface(Config.web3api, Config.contractAddress, Config.minerAddress, Config.privateKey, Config.UsePayMaster, Config.contractAddressPayMaster, WhatAddressToMineTo, Config.gasToMine,
